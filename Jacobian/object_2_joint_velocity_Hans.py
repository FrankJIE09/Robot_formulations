...
def calculate_joint_velocity(Vd, theta):
    ...
    d1, d2, d3, d4, d5, d6, d7, d8 = 260, 168.1, 480, 168.1, 133.1, 520, 133.1, 173.5
    omega1, omega2, omega3, omega4, omega5, omega6 = [0, 1, 0], [0, 0, -1], [0, 1, 0], [0, 0, 1], [0, 1, 0], [0, 0,
                                                                                                              1]
    v1, v2, v3, v4, v5, v6 = ([-d7 + d5 - d4 + d2, 0, 0], [-d8 - d6 - d3, 0, 0], [d8 + d6, 0, 0], [-d7 + d5, 0, 0],
                              [d8, 0, 0], [0, 0, 0])
